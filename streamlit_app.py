...
st.set_page_config(page_title="Foguth Financial Group", page_icon="🎫")
st.title("Foguth Financial Group 🎫 Trade Ticket")
st.write(
    """
...
# in a form, the app will only rerun once the submit button is pressed.
with st.form("add_ticket_form"):
    issue = st.selectbox("Household", households, index=0, help="Select a household for the ticket", key="household_select")
    priority = st.selectbox("Priority", ["High", "Medium", "Low"])
    submitted = st.form_submit_button("Submit")
